...
const Contact = () => {
    return (
        <div>
            <div>
                <Header></Header>
                <div style={{ backgroundColor: '#90ACD4' }}>
                    <div class="container" style={{ paddingTop: '150px' }}>
                        <h2 style={{ padding: '0 0 43px 0' }}>Contact</h2>
                    </div>
                </div>
            </div>

            <section class="section py-5" style={{backgroundColor: '#F7F8FA'}}>
                <div class="container">
                    <div class="row">
                        <div class="contact-intro col-lg-8 mx-lg-auto mb-5 text-center">

                            <img class="profile-small d-inline-block mx-auto rounded-circle mb-3" src={img} alt="" style={{height: '150px',backgroundColor: '#B5BABC'}}/>
